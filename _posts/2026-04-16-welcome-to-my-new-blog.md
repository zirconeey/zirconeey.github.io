---
layout: post
title: 告别 LaTeX 编译后的“副产物”：三招打造极致整洁的科研工作流
date: 2026-04-16
categories: 随笔
---
...
1. 在 VS Code 中按 `Cmd + ,` (Mac) 或 `Ctrl + ,` (Win) 进入设置。
  ...
  ![](https://fastly.jsdelivr.net/gh/bucketio/img11@main/2026/04/16/1776312192991-936f1b10-6577-4519-9fe8-a4ff4b42cf33.png)
 
2. 搜索并修改以下两项：
   - **`latex-workshop.latex.outDir`**: 设置为 `%DIR%/out`。
   - **`latex-workshop.latex.autoClean.run`**: 设置为 `onBuilt`。

![](https://fastly.jsdelivr.net/gh/bucketio/img0@main/2026/04/16/1776312254376-1c939a0d-b624-4ebb-a1b0-34edbc004c90.png)
